...
describe("buildCursorPrompt", () => {
	...
	it("instructs Cursor not to claim web search without an actual Cursor web tool", () => {
		...
		expect(result.text).toContain("prefer pi__mcp for MCP work and pi__task for delegation");
	...
	it("includes shell cd hint in the tool tail guard", () => {
		...
		expect(incremental.text).toContain("prefer pi__mcp for MCP work and pi__task for delegation");
	});
